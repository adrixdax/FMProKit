...
/// An enumeration of all the possible type of error that can be thrown by the functions that interfaces with the Filemaker Database
enum FetchError: Error {
    case tokenRequestError
}

/// Possible errors that may cause HTTP errors
enum FMProErrors: Error {
    case negativeNumber
    case tableNameMissing
    case emptyListOfFields
    case fieldNameMissing
    case indexNameMissing
}

enum ProtocolVersionError: Error {
    case wrongProtocolVersion
}

/// An enumeration of all the possible type of error that can be thrown by the functions that interfaces with the Filemaker Database
enum HTTPError: Error {
    case errorCode100Continue
    case errorCode101SwitchingProtocols
    case errorCode102Processing
    case errorCode300MultipleChoices
    case errorCode301MovedPermanently
    case errorCode302Found
    case errorCode303SeeOther
    case errorCode304NotModified
    case errorCode305UseProxy
    case errorCode306SwitchProxy
    case errorCode307TemporaryRedirect
    case errorCode308PermanentRedirect
    case errorCode400BadRequest
    case errorCode401Unauthorized
    case errorCode402PaymentRequired
    case errorCode403Forbidden
    case errorCode404NotFound
    case errorCode405MethodNotAllowed
    case errorCode406NotAcceptable
    case errorCode407ProxyAuthenticationRequired
    ...
    case errorCode415UnsupportedMediaType
    case errorCode416RangeNotSatisfiable
    case errorCode417ExpectationFailed
    case errorCode418Teapot
    case errorCode421MisdirectedRequest
    case errorCode422UnprocessableEntity
    case errorCode423Locked
    case errorCode424FailedDependecy
    case errorCode426UpgradeRequired
    case errorCode428PreconditionRequired
    case errorCode429TooManyRequests
    case errorCode431RequestHeaderFieldsTooLarge
    case errorCode444NoResponse
    case errorCode451UnavailableForLegalReasons
    case errorCode495SSLCertificateError
    case errorCode496SSLCertificateRequired
    case errorCode497HTTPRequestSentToHTTPSPort
    case errorCode499ClientClosedRequest
    case errorCode500InternalServerError
    case errorCode501NotImplemented
    case errorCode502BadGateway
    case errorCode503ServiceUnavailable
    case errorCode504GatewayTimeout
    case errorCode505HTTPVersionNotSupported
    case errorCode506VariantAlsoNegotiates
    case errorCode507InsufficientStorage
    case errorCode508LoopDetected
    case errorCode510NotExtended
    case errorCode511NetworkAuthenticationRequired
    case undefinedError
}

/// An enumeration that describes the error caused by decoding the structure
